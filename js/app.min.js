...
/******/ (() => {
  ...
  \***********************/
      /***/ (
        ...
        "use strict";
        eval(
          '__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var air_datepicker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! air-datepicker */ "./node_modules/air-datepicker/index.es.js");\n/* harmony import */ var select_pure_dist_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! select-pure/dist/index.js */ "./node_modules/select-pure/dist/index.js");\n\r\n\r\n\r\nconst headerEl = document.querySelector(".header");\r\n\r\nwindow.onscroll = function () {\r\n  console.log("rbvefsd")\r\n  if (window.pageYOffset >= 50) {\r\n    headerEl.classList.add("header--color");\r\n  }\r\n  if (window.pageYOffset < 50) {\r\n    headerEl.classList.remove("header--color");\r\n  }\r\n};\r\n\r\nconst menuBtn = document.querySelector(".header__mob-btn");\r\nconst menuNav = document.querySelector(".header__nav");\r\n\r\ndocument.addEventListener("click", function (event) {\r\n  if (\r\n    !event.target.matches(".header__mob-btn") &&\r\n    !event.target.matches(".header__mob-btn--active") &&\r\n    !event.target.matches(".header__mob-btn span") &&\r\n    !event.target.matches(".header__list") &&\r\n    !event.target.matches(".header__nav") &&\r\n    !event.target.matches(".header__nav--active")\r\n  ) {\r\n    menuNav.classList.remove("header__nav--active");\r\n    menuBtn.classList.remove("header__mob-btn--active");\r\n  }\r\n});\r\n\r\nmenuBtn.addEventListener("click", () => {\r\n  menuBtn.classList.toggle("header__mob-btn--active");\r\n  menuNav.classList.toggle("header__nav--active");\r\n});\r\n\r\nconst copyEl = document.querySelectorAll(".contact__copy-item");\r\ncopyEl.forEach((elm) => {\r\n  elm.addEventListener("click", function () {\r\n    const copyText = elm.innerText;\r\n    navigator.clipboard\r\n      .writeText(copyText)\r\n      .then(() => {\r\n        console.log(`Текст "${copyText}" успешно скопирован в буфер обмена`);\r\n      })\r\n      .catch((err) => {\r\n        console.log("Ошибка при копировании текста: ", err);\r\n      });\r\n  });\r\n});\r\n\r\nconst calenTimes = document.querySelectorAll(".contact__calendar-time");\r\n\r\ncalenTimes.forEach((calenItem) => {\r\n  calenItem.addEventListener("click", function () {\r\n    calenTimes.forEach((calenItem) => {\r\n      calenItem.classList.remove("contact__calendar-time--active");\r\n    });\r\n    this.classList.add("contact__calendar-time--active");\r\n  });\r\n});\r\n\r\nconst localeEn = {\r\n  days: [\r\n    "Sunday",\r\n    "Monday",\r\n    "Tuesday",\r\n    "Wednesday",\r\n    "Thursday",\r\n    "Friday",\r\n    "Saturday",\r\n  ],\r\n  daysShort: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],\r\n  daysMin: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],\r\n  months: [\r\n    "January",\r\n    "February",\r\n    "March",\r\n    "April",\r\n    "May",\r\n    "June",\r\n    "July",\r\n    "August",\r\n    "September",\r\n    "October",\r\n    "November",\r\n    "December",\r\n  ],\r\n  monthsShort: [\r\n    "Jan",\r\n    "Feb",\r\n    "Mar",\r\n    "Apr",\r\n    "May",\r\n    "Jun",\r\n    "Jul",\r\n    "Aug",\r\n    "Sep",\r\n    "Oct",\r\n    "Nov",\r\n    "Dec",\r\n  ],\r\n  today: "Today",\r\n  clear: "Clear",\r\n  dateFormat: "dd/mm/yyyy",\r\n  timeFormat: "hh:ii",\r\n  firstDay: 1,\r\n};\r\n\r\nconst calendar = new air_datepicker__WEBPACK_IMPORTED_MODULE_0__["default"](".contact__calendar", {\r\n  locale: localeEn,\r\n});\r\n\r\nconst findallSwiper = new Swiper(".find-all__slider", {\r\n  slidesPerView: 1,\r\n  spaceBetween: 20,\r\n  loop: true,\r\n  autoplay: {\r\n    delay: 3500,\r\n  },\r\n  breakpoints: {\r\n    1171: {\r\n      slidesPerView: 4,\r\n      spaceBetween: 20,\r\n    },\r\n    991: {\r\n      slidesPerView: 3,\r\n      spaceBetween: 20,\r\n    },\r\n    641: {\r\n      slidesPerView: 2,\r\n      spaceBetween: 20,\r\n    },\r\n  },\r\n});\r\nconst contactSwiper = new Swiper(".contact__footer-slider", {\r\n  freeMode: true,\r\n  slidesPerView: 2.2,\r\n  spaceBetween: 15,\r\n  breakpoints: {\r\n    1171: {\r\n      slidesPerView: 4.5,\r\n    },\r\n    769: {\r\n      slidesPerView: 3.5,\r\n    },\r\n    541: {\r\n      slidesPerView: 2.7,\r\n    },\r\n    376: {\r\n      slidesPerView: 2.7,\r\n      spaceBetween: 20,\r\n    },\r\n  },\r\n});\r\n\r\nconst gridsEls = document.querySelectorAll(".contact__grids-item");\r\nconst gridMain = document.querySelector(".contact__item-main");\r\nconst mainNoHidden = document.querySelectorAll(".item-nonmain");\r\nconst contactsHidden = document.querySelectorAll(".contact__item-hidden");\r\n\r\nmainNoHidden.forEach((mainNoEl) => {\r\n  mainNoEl.addEventListener("click", () => {\r\n    gridMain.classList.remove("contact__item-main--hidden");\r\n    contactsHidden.forEach((el) => {\r\n      el.classList.remove("contact__item-main--nonhidden");\r\n    });\r\n  });\r\n});\r\ngridsEls.forEach((gridEl, idx) => {\r\n  gridEl.addEventListener("click", () => {\r\n    gridMain.classList.add("contact__item-main--hidden");\r\n    contactsHidden[idx].classList.add("contact__item-main--nonhidden");\r\n  });\r\n});\r\nconst item1 = document.querySelector(".contact__item-1");\r\nconst item2 = document.querySelector(".contact__item-2");\r\nconst item3 = document.querySelector(".contact__item-3");\r\nconst item4 = document.querySelector(".contact__item-4");\r\nconst item5 = document.querySelector(".contact__item-5");\r\nconst footItem1 = document.querySelectorAll(".contact__footer-item-1");\r\nconst footItem2 = document.querySelectorAll(".contact__footer-item-2");\r\nconst footItem3 = document.querySelectorAll(".contact__footer-item-3");\r\nconst footItem4 = document.querySelectorAll(".contact__footer-item-4");\r\nconst footItem5 = document.querySelectorAll(".contact__footer-item-5");\r\nfootItem1.forEach((itEl) => {\r\n  itEl.addEventListener("click", () => {\r\n    if (item1.classList.contains("contact__item-main--nonhidden")) {\r\n      item1.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    if (item2.classList.contains("contact__item-main--nonhidden")) {\r\n      item2.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    if (item3.classList.contains("contact__item-main--nonhidden")) {\r\n      item3.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    if (item4.classList.contains("contact__item-main--nonhidden")) {\r\n      item4.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    if (item5.classList.contains("contact__item-main--nonhidden")) {\r\n      item5.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    item1.classList.add("contact__item-main--nonhidden");\r\n  });\r\n});\r\nfootItem2.forEach((itEl) => {\r\n  itEl.addEventListener("click", () => {\r\n    if (item1.classList.contains("contact__item-main--nonhidden")) {\r\n      item1.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    if (item2.classList.contains("contact__item-main--nonhidden")) {\r\n      item2.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    if (item3.classList.contains("contact__item-main--nonhidden")) {\r\n      item3.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    if (item4.classList.contains("contact__item-main--nonhidden")) {\r\n      item4.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    if (item5.classList.contains("contact__item-main--nonhidden")) {\r\n      item5.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    item2.classList.add("contact__item-main--nonhidden");\r\n  });\r\n});\r\nfootItem3.forEach((itEl) => {\r\n  itEl.addEventListener("click", () => {\r\n    if (item1.classList.contains("contact__item-main--nonhidden")) {\r\n      item1.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    if (item2.classList.contains("contact__item-main--nonhidden")) {\r\n      item2.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    if (item3.classList.contains("contact__item-main--nonhidden")) {\r\n      item3.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    if (item4.classList.contains("contact__item-main--nonhidden")) {\r\n      item4.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    if (item5.classList.contains("contact__item-main--nonhidden")) {\r\n      item5.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    item3.classList.add("contact__item-main--nonhidden");\r\n  });\r\n});\r\nfootItem4.forEach((itEl) => {\r\n  itEl.addEventListener("click", () => {\r\n    if (item1.classList.contains("contact__item-main--nonhidden")) {\r\n      item1.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    if (item2.classList.contains("contact__item-main--nonhidden")) {\r\n      item2.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    if (item3.classList.contains("contact__item-main--nonhidden")) {\r\n      item3.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    if (item4.classList.contains("contact__item-main--nonhidden")) {\r\n      item4.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    if (item5.classList.contains("contact__item-main--nonhidden")) {\r\n      item5.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    item4.classList.add("contact__item-main--nonhidden");\r\n  });\r\n});\r\nfootItem5.forEach((itEl) => {\r\n  itEl.addEventListener("click", () => {\r\n    if (item1.classList.contains("contact__item-main--nonhidden")) {\r\n      item1.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    if (item2.classList.contains("contact__item-main--nonhidden")) {\r\n      item2.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    if (item3.classList.contains("contact__item-main--nonhidden")) {\r\n      item3.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    if (item4.classList.contains("contact__item-main--nonhidden")) {\r\n      item4.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    if (item5.classList.contains("contact__item-main--nonhidden")) {\r\n      item5.classList.remove("contact__item-main--nonhidden");\r\n    }\r\n    item5.classList.add("contact__item-main--nonhidden");\r\n  });\r\n});\r\n\n\n//# sourceURL=webpack://mygulp2022/./src/js/app.js?'
        );
